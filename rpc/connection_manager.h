...
class ConnectionManager {
    ...
    public:
        ...
        int32_t RecvMsg(int32_t fd, string& recv_msg_str);

        int32_t SendMsg(int32_t fd, string& send_msg_str);
        ...
        // read and write 
        int32_t EpollRecvMsg(int32_t fd, string& recv_msg_str);

        int32_t EpollSendMsg(int32_t fd, string& send_msg_str);
